          ...
          <div className="flex items-center justify-between">
            ...
            >
              <div className="flex h-8 w-8 items-center justify-center rounded-xl bg-white shadow-lg">
                <img src="/logo.png" alt="LingslatePal Logo" className="h-6 w-6" /> {/* Logo added */}
              </div>
              <div className="flex h-8 w-8 items-center justify-center rounded-xl bg-white shadow-lg">
                {/* Placeholder for secondary logo */}
              </div>
            ...
            >
              <Link href="/auth/login">
                <Button variant="ghost" className="hidden sm:inline-flex text-primary-foreground hover:bg-blue-900/30">
                  Login
                </Button>
              </Link>
              <Link href="/auth/register">
                <Button className="bg-black text-white hover:bg-gray-800 shadow-lg hover:shadow-xl transition-all duration-200 px-4 py-2 text-sm max-w-[120px] sm:max-w-[150px]">
                  Get Started
                </Button>
              </Link>
            </motion.div>
            ...
            <div className="space-y-4">
              <div className="flex items-center space-x-3">
                <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-primary shadow-lg">
                  <img src="/logo.png" alt="LingslatePal Logo" className="h-8 w-8" /> {/* Logo added */}
                </div>
                <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-primary shadow-lg">
                  {/* Placeholder for secondary logo */}
                </div>
